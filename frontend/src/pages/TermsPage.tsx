      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 selection:bg-slate-200 dark:selection:bg-slate-700 text-slate-600 dark:text-slate-400">
        <div className="max-w-2xl mx-auto py-12 px-6">
          ...
          <div className="space-y-12">
            <section>
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-50 mb-4">1. Acceptance of Agreement</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-50 mb-4">2. User Accountability</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-50 mb-4">3. Intellectual Property</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-50 mb-4">4. Acceptable Use</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-50 mb-4">5. Disclaimer of Warranties</h2>
              <p className="leading-relaxed">
